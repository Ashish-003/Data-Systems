 ...
 * @return Page
 */
Page BufferManager::getPage(string tableName, int pageIndex, bool isUpdate)
{
    ...
    if (this->inPool(pageName))
        ...
        return this->insertIntoPool(tableName, pageIndex, isUpdate);
}
 ...
 * @return Page
 */
Page BufferManager::insertIntoPool(string tableName, int pageIndex, bool isUpdate)
{
    logger.log("BufferManager::insertIntoPool");
    Page page(tableName, pageIndex, isUpdate);
 ...
 * @param rowCount
 */
void BufferManager::writePage(string tableName, int pageIndex, vector<vector<int>> rows, int rowCount, bool isUpdate)
{
    logger.log("BufferManager::writePage");
    Page page(tableName, pageIndex, rows, rowCount);
    page.writePage(isUpdate);
}
