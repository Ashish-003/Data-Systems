...
public:
    ...
    void redistributeLeftLeaf(int index);
    void mergeLeftLeaf(int index);
    void redistributeRightLeaf(int index);
    void mergeRightLeaf(int index);

    void redistributeLeftInternal(int index);
    void mergeLeftInternal(int index);
    void redistributeRightInternal(int index);
    void mergeRightInternal(int index);
